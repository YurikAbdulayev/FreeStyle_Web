...
<div id="templatemo_wrapper">
  ...
  <div id="templatemo_main">
    ...
    <div id="templatemo_content">
      <form action="/reneval" method="post" style="margin-bottom: 0em;">
        <a>Обліковий рахунок <input type="text"  name="idcount">
          <br></br>
        <a>На скільки поповнити <input type="text"  name="summtf">
          <a><input type="submit" value="Поповнити" >
